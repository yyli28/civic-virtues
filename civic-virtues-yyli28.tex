...
\abstract{The study investigated civic virtues among international and
...
(\citeproc{ref-boulwareStrangerStrangeLand2023}{Boulware et al., 2023}),
...
and Faul (\citeproc{ref-doolittleCivicEngagementScale2013}{2013})
...
(\citeproc{ref-difabioAssessingWorkplaceRelational2016}{Di Fabio \&
Gori, 2016}). Sample items include ``I was able to express my values and
...
(\citeproc{ref-zarrettRoleOrganizedActivities2021}{Zarrett et al.,
2021}). Several limitations should be considered when interpreting the
...
\bibitem[\citeproctext]{ref-difabioAssessingWorkplaceRelational2016}
...
\bibitem[\citeproctext]{ref-doolittleCivicEngagementScale2013}
